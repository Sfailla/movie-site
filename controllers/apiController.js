...
module.exports = function(app) {
    ...
    app.get('/', (req, res, next) => {
      res.render('home', { title: 'Welcome to My Movie Site', message: 'In this site you will be able to view, add, update and delete movies.  To see what movies are currently available press the get movies button!', include: true } );
    });
    ...
    app.get('/api/movies', (req, res) => {
      Movie.getMovies( (err, movies) => {
        if (err) throw err;
        res.render('movies', { title: 'Welcome to the Movies Page', moviesPage: true, movies: movies } );
      });
    });
